    ...
    <div class="grid grid-cols-5 lg:grid-cols-9 xl:grid-cols-10 gap-4">
        <div class="block">
            <div class="col-span-1 xl:col-span-2 h-screen flex flex-col pt-2 border-r fixed xl:mr-4">
                ...
                <div class="w-fit mx-auto flex text-xl xl:hover:bg-gray-200 rounded-3xl pr-2 cursor-pointer xl:mr-[100px]">
                    <i class="fa-solid fa-gear p-4 mx-auto rounded-full hover:bg-gray-100 button "></i>
                    <p class="hidden xl:block text-xl mt-3 mr-6">Paramètres</p>
                </div>
            </div>
        </div>
        <div class="h-fit col-span-3 lg:col-span-5 rounded-3xl mt-2 xl:pl-32 xl:ml-12">
            <div class="flex">
        ...
        <div class="fixed bottom-0 w-full bg-blue-500">
            <div class="flex justify-evenly mx-auto h-fit gap-8">
                ...
                <button class="rounded-3xl text-white border w-1/2 lg:1/6 mt-4 mb-4 ml-4 button">Se connecter</button>
                <button class="text-block bg-white rounded-3xl mr-4 w-1/2 lg:1/6 mt-4 mb-4">Utiliser l'application</button>
            </div>
        </div>
    </div>
