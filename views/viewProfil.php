...
<div class="w-full flex flex-col top-0">
    ...
    <div class="profile w-full">
        ...
        <div class="profilePicture">
            <img class="mt-[-60px] object-cover outline outline-4 outline-white ml-6 rounded-full w-32 h-32 max-sm:w-24 max-sm:mt-[-50px] max-sm:ml-3" src="<?= "../../img/" . $_SESSION["user_data"]["picture"] ?>">
        </div>
        ...
        <div class="userInfo ml-8 mt-4">
            ...
            <div class="followers flex mt-4 max-sm:flex-col">
                ...
                <p class="ml-4 max-sm:ml-0">Nb abonnés</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="popup bg-white flex flex-col justify-center items-center m-auto max-w-md h-auto rounded-lg text-black p-1">
        ...
        <form class="editForm flex flex-col justify-center items-center w-full mb-8" id="editForm" autocomplete="off">
            ...
            <div class="banner w-full flex flex-col relative">
                <img class="w-full h-40 object-cover" src="<?= "../../img/" . $_SESSION["user_data"]["banner"] ?>">
            ...
            <div class="profilePicture w-32 self-start flex flex-col relative left-0 outline outline-4 outline-white ml-3 rounded-full mt-[-70px] mb-4">
                <img class="object-cover outline outline-4 outline-white rounded-full w-32 h-32" src="<?= "../../img/" . $_SESSION["user_data"]["picture"] ?>">
                <div class="absolute flex justify-center items-center inset-0 w-full h-full rounded-full opacity-0 ease duration-300 bg-gray-200 hover:opacity-50">
            ...
            <div class="username mb-3 w-2/3">
                <input type="text" id="nickname" name="nickname" placeholder="Pseudo" value=<?= $_SESSION["user_data"]["nickname"] ?> class="w-full p-2 bg-gray-200 placeholder:text-blue-500 text-blue-500 border-2 border-blue-500 rounded-md font-semibold"></input>
            </div>
            <div class="editEmail mb-1 w-2/3">
                <label for="email" class="font-semibold">*Email:</label>
            </div>
            <div class="editEmail mb-3 w-2/3">
                <input type="email" id="email" name="email" placeholder="exemple@test.com" value=<?= $_SESSION["user_data"]["email"] ?> class="w-full p-2 bg-gray-200 placeholder:text-blue-500 text-blue-500 border-2 border-blue-500 rounded-md font-semibold"></input>
            </div>
